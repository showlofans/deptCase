...
public class CaseContactVO {
    ...
    private String lastAccessStr;			//最后更新
     ...
     * @param caseId
     */
    public CaseContactVO(String contactName, String contactDcid,
			String householdShip, String householdLocation, Long lastAccess,
			Integer contactAddUser,String householdDcid, Long caseId,String contactNumber) {
		super();
